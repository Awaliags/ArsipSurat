...
<head>
    <meta charset="UTF-8">
    <title>Surat Keluar - MAS YAPENSA</title>
...
<div class="main">
    <div class="top-bar">
        <div class="left">Surat Keluar</div>
        <div class="right">
            <form method="get">
                <input type="text" name="cari" placeholder="Cari..." value="<?= htmlspecialchars($cari) ?>">
            </form>
            <button onclick="window.location.href='tambah_surat_keluar.php'">Tambah surat keluar</button>
        </div>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div style="display: flex;">
                        <a href="edit_surat_keluar.php?id=<?= $data['id'] ?>" class="btn-edit"><i class="fa-solid fa-pencil"></i></a>
                        <a href="hapus_surat_keluar.php?id=<?= $data['id'] ?>" class="btn-delete" onclick="return confirm('Yakin ingin menghapus?')"><i class="fa-solid fa-trash"></i></a>
                    </div>                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
